...
export class UpdateService {
  ...
  constructor(private updates: SwUpdate, private confirmationDialogService: ConfirmationDialogService, private messageDialogServive: MessageDialogService) { }

  startTimer() {
    const updateInterval$ = interval(30 * 1000);
