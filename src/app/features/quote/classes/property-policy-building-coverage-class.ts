...
export class PropertyPolicyBuildingCoverageClass implements PropertyBuildingCoverage, Validation, QuoteAfterSave {
  ...
  building!: PropertyPolicyBuildingClass;
  invalidList: string[] = [];
  ...
  existingInit(coverage: PropertyBuildingCoverage) {
    ...
    this.propertPolicyBuildingCoverageId = coverage.propertPolicyBuildingCoverageId;
