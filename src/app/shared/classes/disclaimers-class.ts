...
import { Disclaimers } from '../interfaces/disclaimers';
import { Validation } from '../interfaces/validation';

export abstract class DisclaimersClass implements Disclaimers, Validation, QuoteAfterSave{
  ...
  constructor(disclaimers?: Disclaimers){
    ...
    this._validationResults = new QuoteValidationClass(ValidationTypeEnum.Child, QuoteValidationTabNameEnum.FormsList);
    this.validate();
  }
  ...
  existingInit(sub: Disclaimers){
    ...
    this.disclaimerDesc = sub.disclaimerDesc;
